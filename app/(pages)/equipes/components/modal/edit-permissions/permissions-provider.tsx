...
export default function PermissionsProvider({
  ...
  const { permissions, refetch } = usePermission(
    undefined,
    parseInt(equipeid),
    usuario,
  );
    ...
    <div className="grid gap-4 py-1 pt-0 mt-2">
      <div className="flex flex-start flex-col flex-row">
        ...
        <MultiPermissionSelector
          ...
          getValues={getValues}
          equipeid={equipeid}
          presets={[{ id: 1, nome: 'Administrador', value: 'ADMINISTRADOR' }]}
        />
        ...
        <MultiPermissionSelector
          ...
          getValues={getValues}
          equipeid={equipeid}
          presets={[{ id: 1, nome: 'Editar', value: 'EDITAR_USUARIOS' }]}
        />
        <hr className="mt-4 mb-2" />
        ...
        <MultiPermissionSelector
          ...
          equipeid={equipeid}
          presets={[
            { id: 1, nome: 'Visualizar', value: 'VISUALIZAR_EQUIPE' },
