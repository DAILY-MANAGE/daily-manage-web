...
export default function LogsButton({ usuario, equipeId }: LogsButtonProps) {
  ...
  return <Button onClick={() => router.push(`/registros/${equipeId}/${usuario}`)} variant={'outline'} type="button" className="w-12 h-12 aspect-square px-2 py-1 bg-gray-600 hover:bg-gray-800">
