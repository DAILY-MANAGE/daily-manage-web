...
export const VER_TODAS_PERMISSOES_DO_USUARIO_LOGADO_NA_EQUIPE =
  '/equipes/usuarios/permissoes';
export const VER_TODAS_PERMISSOES_POR_EQUIPE =
  '/equipes/usuarios/usuario/permissoes';
...
export const EDITAR_PERMISSOES_DE_UM_USUARIO_POR_USUARIO =
  '/equipes/usuarios/usuario';
export const REMOVER_USUARIO_DA_EQUIPE_POR_USUARIO =
  '/equipes/usuarios/usuario';
...
export const RESPONDER_FORMULARIO =
  '/equipes/formularios/{formularioId}/responder';
export const VER_RESPOSTAS_DE_UM_FORMULARIO =
  '/equipes/formularios/{formularioId}/respostas';
export const VER_RESPOSTA_POR_ID =
  '/equipes/formularios/respostas/{formularioRespondidoId}';
export const EDITAR_RESPOSTA =
  '/equipes/formularios/respostas/{formularioRespondidoId}';
export const EXCLUIR_RESPOSTA =
  '/equipes/formularios/respostas/{formularioRespondidoId}';
export const VER_ESTATISTICA_FORMULARIO =
  '/equipes/formularios/{formularioId}/estatisticas';
...
export const VISUALIZAR_NOTIFICACAO =
  '/notificacoes/visualizar/{notificacaoId}';
